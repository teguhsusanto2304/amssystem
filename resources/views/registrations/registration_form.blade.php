            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-10">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group mb-3">
                                            {{ Form::text('medical_record_no', null, array('readonly'=>true,'id'=>'medical_record_no','placeholder' => 'No RM','class' => 'form-control '.(!empty($errors->first('rekam_medis_id'))?'is-invalid':''))) }}
                                            ...
                                            <button class="btn btn-success" id="btnResetPasien" type="button" ><i class="fas fa-plus" ></i></button>
                                            <button class="btn btn-warning" id="btnResetPasien" type="button" ><i class="fas fa-eraser" ></i></button>
                                            {{ Form::hidden('rekam_medis_id', null, array('id' => 'rekam_medis_id')) }}
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="row">
                                                            ...
                                                            <table id="datatable_pasien" class="table table-bordered dt-responsive nowrap data-table table-striped table-primary" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                                <thead>
                                                                    <tr>
                                                                        <th width="2%">No</th>
                                                                        <th width="50%">Nama</th>
                                        ...
                                        @error('rekam_medis_id') <small class="text-danger"> {{ $errors->first('rekam_medis_id') }}</small> @enderror
                                    </div>
                                </div> <!-- end col -->
                                <div class="col-md-6">
                                    <div class="mb-3">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-sm-4">
                                <div class="mb-3">
                                    ...
                                    @error('service_unit_id') <small class="text-danger"> {{ $errors->first('service_unit_id') }}</small> @enderror
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="mb-3">
                        ...
                        <h5 class="font-size-14 mb-4"><i class="mdi mdi-arrow-right text-primary me-1"></i> Kunjungan</h5>
...
<div class="modal-dialog modal-xl">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <table id="datatable_dokter" class="table table-bordered dt-responsive nowrap data-table table-striped table-primary" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                <thead>
                    <tr>
                        <th width="2%">No</th>
                        <th>Nama</th>
...
<script type="text/javascript">
   $(function () {
    var name = 1;
      var poli = 2;
    var table_dokter = $('#datatable_dokter').DataTable({
          processing: true,
          serverSide: true,
          columnDefs: [
        ...
        drawCallback: function (settings) {
          ...
          ajax: "{{ route('registrations.doctors.search',1) }}",
          columns: [
          ...
          "columnDefs": [
        {
          "render" : function(data,type,row){
            return "<div class=\"btn-group\"> <button type=\"button\"  onclick=\" rowDokterDataGet ('"+row['id']+"','"+row['name']+"','"+row['service_unit']+"','"+row['jam_mulai']+" - "+row['jam_akhir']+"','"+row['service_unit_id']+"') \" class=\"btn btn-primary\" >Pilih</button></div>"
          },
          "targets" : 7
        }],
      });
      var table = $('#datatable_pasien').DataTable({
          processing: true,
          serverSide: true,
          scrollY:"250px",
        ...
        {
          "render" : function(data,type,row){
            return "<div class=\"btn-group\"> <button type=\"button\"  onclick=\" rowDataGet ('"+row['medical_record_no']+"','"+row['fullname']+"','"+row['title']+"','"+row['date_of_birth']+"','"+row['gender']+"','"+row['phone_number']+"','"+row['id']+"') \" class=\"btn btn-primary\" >Pilih</button></div>"
          },
          "targets" : 3
        }
      ],
    ...
    function rowDataGet (a,b,c,d,e,f,g) {
        $('#medical_record_no').val(a);
        $('#rekam_medis_id').val(g);
        $('#fullname').val(b);
        $('#title').val(c);
        $('#date_of_birth').val(d);
        $("#usia").val(getAge(d));
