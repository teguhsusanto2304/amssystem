...
@section('title', config('title.registration'))
@section('subtitle', 'Halaman '.config('title.registration'))
@section('content')
<style>
    .red {
                            ...
                            <div class="mb-3">
                                <div class="input-group mb-3">
                                    ...
                                    @can('registration-create')
                                        <a class="btn btn-success" href="{{ route('registrations.registration') }}"> @yield('title') Baru</a>
                                    @endcan
                                </div>
                            </div>
                        </div>
