        ...
        <div class="modal-footer">
            ...
            <div class="col-md-2">
                <div class="mb-3">
                    ...
                    {!! Form::select('title',['Bpk' => 'Bapak', 'Ibu' => 'Ibu', 'Sdr' => 'Saudara', 'Sdri' => 'Saudari', 'Ank' => 'Anak', 'By' => 'Bayi', 'Inf' => 'Inf'],null, array('id'=>'title','placeholder' => 'Pilih','class' => 'form-control')) !!}
                </div>
            </div> <!-- end col -->
            <div class="col-md-3">
                <div class="mb-3">
                    <label class="form-label" for="formrow-password-input">Jenis kelamin</label>
                    {!! Form::select('gender',['Perempuan' => 'perempuan', 'Lelaki' => 'Lelaki'],null, array('id'=>'gender','placeholder' => 'Pilih','class' => 'form-control')) !!}
                </div>
            </div> <!-- end col -->
            <div class="col-md-3">
                <div class="mb-3">
            ...
            <div class="col-md-9">
                <div class="mb-3">
                    ...
                    {!! Form::text('fullname', null, array('id'=>'fullname','placeholder' => 'Nama lengkap','class' => 'form-control')) !!}
                </div>
            </div> <!-- end col -->
            <div class="col-sm-3">
                <div class="mb-3">
                    <label class="form-label" for="formrow-firstname-input">{{ $config['column'][3] }}</label>
                    {!! Form::date(config('global.appointment_field')['dob'], (!is_null($data)?$data->prosentase_appointment_dokter:null), array('id'=>config('global.appointment_field')['dob'],'readonly'=>false,'placeholder' => $config['column'][2],'class' => 'form-control')) !!}
                </div>
            </div>
        </div> <!-- end row -->
        <div class="row">
            <div class="col-sm-3">
                <div class="mb-3">
                    ...
                    {!! Form::input('dateTime-local',config('global.appointment_field')['tgl'], (!is_null($data)?$data->prosentase_appointment_dokter:null), array('type'=>'datetime-local','placeholder' => $config['column'][2],'class' => 'form-control')) !!}
                </div>
            </div>
            <div class="col-sm-5">
                <div class="mb-3">
                    <label class="form-label" for="formrow-firstname-input">{{ $config['column'][5] }}</label>
                    <div class="input-group mb-3">
                    ...
                    {!! Form::text('nama_dokter', (!is_null($data)?$data->prosentase_rumah_sakit:null), array('id'=>'nama_dokter','placeholder' => 'nama dokter','class' => 'form-control')) !!}
            ...
            <div class="col-sm-4">
                <div class="mb-3">
                    <label class="form-label" for="formrow-firstname-input">{{ $config['column'][6] }}</label>
