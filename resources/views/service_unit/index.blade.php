        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="pull-right">
                    <a class="btn btn-success" href="{{ route('serviceunits.create') }}"> Create @yield('title')</a>
                </div>
                <br>
...
<script type="text/javascript">
    ...
    $(function () {
      ...
      var table = $('.data-table').DataTable({
          processing: true,
          serverSide: true,
          ajax: "@php echo route($header['url']) @endphp",
          columns: [
              {data: 'DT_RowIndex' , name: 'id'},
              {data: 'service_unit', name: 'service_unit'},
              {data: 'tipe_service_unit', name: 'tipe_service_unit'},
