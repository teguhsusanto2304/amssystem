...
@section('title', 'Transaksi Resep Obat')
@section('subtitle', 'Halaman Transaksi Resep Obat')
@section('content')
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <div class="pull-right">
                    <a class="btn btn-success" href="{{ route('farmasi.transaksi.addmedicine',$kunjungan) }}"> Tambah Obat</a>
                </div>
