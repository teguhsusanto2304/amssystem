...
class DistrictController extends Controller
{
    ...
    {
        if ($request->ajax()) {
            $data = District::join('cities','districts.city_id','=','cities.id')
            ->join('provinces','cities.prov_id','=','provinces.id')
            ->select('districts.id','provinces.province','cities.city','districts.district','districts.data_status')->orderBy('cities.id','ASC');
